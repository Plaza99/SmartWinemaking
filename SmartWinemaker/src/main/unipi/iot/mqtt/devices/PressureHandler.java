...
public class PressureHandler implements TopicHandler{
	public static int lowerBoundPressure = 40;
	public static int upperBoundPressure = 60;
	...
	private static class Statistics {
		...
		public static final int lowerBoundPressure = 15;
		public static final int upperBoundPressure = 25;
		private final List<Datum> data = new ArrayList<>();

		public void add(int temperature) {
			Datum datum = new Datum();
			datum.pressure = temperature;
		...
		public int getLowerBoundTemperature() {
			return lowerBoundPressure;
		}

		public int getUpperBoundTemperature() {
			return upperBoundPressure;
		}
		...
		public double average() {
			return data.stream().map(datum -> (double) datum.pressure) // take only the humidity
					.reduce(0.0d, Double::sum) / data.size();
		}

		public double midRange() {
			return (lowerBoundPressure + upperBoundPressure) / 2;
		}
	}
